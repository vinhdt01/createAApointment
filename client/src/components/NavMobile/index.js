...
function NavMobile({changeLogin ,changeLogout , removeHandle , hide , handleSchedule}) {
    return (
        <div className={clsx(styles.container ,{[styles.hide]:hide} )}>
               ...
               <div style={{paddingTop: '4px', fontFamily:'Helvetica' , fontWeight:'bold',textDecoration: 'none', color:'black' , cursor: 'pointer'}} onClick={handleSchedule}> TẠO LỊCH HẸN </div>
